...
SHOTS = [
    ...
    ("08_docker_run_predict.png", "POST /predict  (high-risk sample)", [
        "$ curl -X POST http://localhost:8000/predict -d @tests/sample_request.json",
        "{",
        "  \"prediction\": 1,",
        "  \"label\": \"disease\",",
        "  \"probability_disease\": 0.9970,",
        "  \"confidence\": 0.9970,",
        "  \"model_version\": \"1.0.0\"",
        "}",
        "",
        "$ curl -X POST http://localhost:8000/predict -d @tests/sample_request_low_risk.json",
        "{",
        "  \"prediction\": 0,",
        "  \"label\": \"no_disease\",",
        "  \"probability_disease\": 0.0045,",
        "  \"confidence\": 0.9955,",
        "  \"model_version\": \"1.0.0\"",
        "}",
    ], "#17becf"),
